<template>
  <div class="min-h-screen py-16 px-4">
    <div class="w-3/5 mx-auto">
      ...
      <!-- Sections -->
      <div class="space-y-10 text-(--primary-black)">
        <!-- 1. Überblick -->
        <section>
          <h2 class="section-heading">1. Datenschutz auf einen Blick</h2>

          <h3 class="section-subheading">Allgemeine Hinweise</h3>
          ...
          <h3 class="section-subheading">Datenerfassung auf dieser Website</h3>

          <h4 class="section-subheading2">
          ...
          <h4 class="section-subheading2">Wie erfassen wir Ihre Daten?</h4>
          <p class="section-text">
          ...
          <h4 class="section-subheading2">Wofür nutzen wir Ihre Daten?</h4>
          <p class="section-text">
        ...
        <!-- 2. Hosting -->
        <section>
          <h2 class="section-heading">2. Hosting</h2>
          <p class="section-text">
            Wir hosten die Inhalte unserer Website bei folgendem Anbieter:
          </p>

          <h3 class="section-subheading">All-Inkl</h3>
          <p class="section-text">
            Anbieter ist die ALL-INKL.COM – Neue Medien Münnich, Inh. René
            Münnich, Hauptstraße 68, 02742 Friedersdorf (nachfolgend All-Inkl).
          ...
          <h3 class="section-subheading">Auftragsverarbeitung</h3>
          <p class="section-text">
        ...
        <section>
          ...
          <h3 class="section-subheading">Datenschutz</h3>
          <p class="section-text">
            Die Betreiberin dieser Seiten nimmt den Schutz Ihrer persönlichen
          ...
          <h3 class="section-subheading">Speicherdauer</h3>
          <p class="section-text">
          ...
          <p class="section-text">
            ...
            Informationen in Ihr Endgerät eingewilligt haben, erfolgt die
            ...
            erforderlich, verarbeiten wir Ihre Daten auf Grundlage von Art. 6
            Abs. 1 lit. b DSGVO. Des Weiteren verarbeiten wir Ihre Daten, sofern
            diese zur Erfüllung einer rechtlichen Verpflichtung erforderlich
          ...
          <p class="section-text uppercase font-semibold">
          ...
          <h3 class="section-subheading">Recht auf Datenübertragbarkeit</h3>
          <p class="section-text">
          ...
          <h3 class="section-subheading">SSL- bzw. TLS-Verschlüsselung</h3>
          <p class="section-text">
            Diese Seite nutzt aus Sicherheitsgründen und zum Schutz der
            Übertragung vertraulicher Inhalte, wie zum Beispiel Bestellungen
            oder Anfragen, die Sie an uns als Seitenbetreiberin senden, eine
          ...
          <h3 class="section-subheading">Widerspruch gegen Werbe-E-Mails</h3>
          <p class="section-text">
            Der Nutzung von im Rahmen der Impressumspflicht veröffentlichten
            Kontaktdaten zur Übersendung von nicht ausdrücklich angeforderter
            Werbung und Informationsmaterialien wird hiermit widersprochen. Die
            Betreiberin der Seiten behält sich ausdrücklich rechtliche Schritte
        ...
        <!-- 4. Datenerfassung -->
        <section>
          <h2 class="section-heading">4. Datenerfassung auf dieser Website</h2>

          <h3 class="section-subheading">Server-Log-Dateien</h3>
          <p class="section-text">
          ...
          <h3 class="section-subheading">Kontaktformular</h3>
          <p class="section-text">
          ...
          <h3 class="section-subheading">Anfrage per E-Mail</h3>
          <p class="section-text">
            Wenn Sie uns per E-Mail kontaktieren, wird Ihre Anfrage inklusive
            aller daraus hervorgehenden personenbezogenen Daten (Name, Anfrage)
        ...
        <!-- 5. Plugins und Tools -->
        <section>
          <h2 class="section-heading">5. Plugins und Tools</h2>

          <h3 class="section-subheading">Google Fonts (lokales Hosting)</h3>
          <p class="section-text">
            Diese Seite nutzt zur einheitlichen Darstellung von Schriftarten
            sogenannte Google Fonts, die von Google bereitgestellt werden. Die
...
.datenschutz-title {
  @apply text-2xl 2xl:text-4xl font-bold uppercase text-(--primary-orange) mb-3;
}

.section-heading {
  @apply text-left text-xl 2xl:text-2xl font-bold text-(--primary-orange) uppercase mb-4;
}

.section-subheading {
  @apply text-left text-base 2xl:text-lg font-bold text-(--primary-black) mb-2;
}

.section-subheading2 {
  @apply text-left text-sm 2xl:text-base font-semibold text-(--primary-black) mb-2;
}
...
.section-list {
  @apply list-disc list-inside mb-4 space-y-1 pl-2;
}

.section-hr {
  @apply border-(--primary-orange) opacity-15;
}

.section-link {
  @apply text-(--primary-orange) underline underline-offset-2 hover:opacity-70 transition-opacity;
}
</style>
